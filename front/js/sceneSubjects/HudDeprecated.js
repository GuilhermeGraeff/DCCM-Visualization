...
function Hud(camera, hudVisibility) {
	...
	const geometry2 = new THREE.PlaneGeometry(window.innerWidth/500, window.innerHeight/1000)
	...
	plane2.position.set(0, -0.5, -2);
    plane2.renderOrder = 1000;
